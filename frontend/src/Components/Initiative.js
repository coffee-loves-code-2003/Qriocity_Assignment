...
import {addnewInitiative} from '../actions/initiativeActions'
function Initiative() {
    ...
    const submitPost=(e)=>
    {
      ...
      dispatch(addnewInitiative(algorithmDataJSON));
...
<div class="flex items-center justify-center w-full">
  ...
  <select id="countries" value={userData.category} name="category" onChange={onChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    <option selected>Select a category</option>
    <option value="Green environment">Green environment</option>
    <option value="Save Water">Save Water</option>
    <option value="Waste Management">Waste Management</option>
    <option value="Pollution Free">Pollution Free</option>
